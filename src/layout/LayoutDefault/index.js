    ...
    return (
        <>
            <nav id="header" className="sticky top-0 z-50 shadow-md mb-8">
                <div className="bg-white w-full top-0 left-0 z-40 px-4 sm:px-8">
                    <div className="">
                            ...
                            <div className="flex items-center gap-4 sm:gap-6">
                                ...
                                <ul className="flex items-center gap-8">
                                    <li>
                                        <NavLink
                                            to="/"
                                            className="text-gray-700 font-semibold hover:text-cyan-700 hidden md:block"
                                        >
                                            Trang chủ
                                        </NavLink>
                                    </li>
                                    <li className="relative group">
                                        ...
                                        {/* Dropdown */}
                                        <div className="absolute hidden group-hover:block bg-white shadow-lg rounded-md -ml-4 z-50">
                                            <ul>
                                                {/* Điện thoại */}
